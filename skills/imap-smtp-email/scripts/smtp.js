...
function createTransporter() {
  ...
  // Override connection to use SOCKS5 proxy
  const originalConnect = transporter.transporter.connect;
  transporter.transporter.connect = function(...args) {
